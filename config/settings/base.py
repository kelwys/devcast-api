...
)  # (devcast_api/config/settings/base.py - 3 = devcast_api/)
APPS_DIR = ROOT_DIR.path("devcast_api")
...
LOCAL_APPS = [
    "devcast_api.users.apps.UsersConfig",
    "devcast_api.episodes.apps.EpisodesConfig",
...
MIGRATION_MODULES = {"sites": "devcast_api.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "devcast_api.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Kelwy Oliveira""", "kelwyduarte@gmail.com")]
